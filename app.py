...
# PAGE CONFIG
# ===============================
st.set_page_config("Paddy Leaf Disease Detection", "🌾", layout="centered")

# ===============================
# CONFIG
# ===============================
ADMIN_EMAIL = "project4@gmail.com"
ADMIN_PASSWORD = "batch4"

MODEL_PATH = "paddy_disease_model.h5"
IMG_SIZE = 224

SENDER_EMAIL = "jyothendrapithani@gmail.com"
SENDER_PASSWORD = "kmohnnhryizbskdl"
...
# ===============================
    ...
    st.button("⬅ Back", on_click=go, args=("login",))
